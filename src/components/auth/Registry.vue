<template>
  <div class="auth">
    <div class="auth__wrapper">
      ...
      <h3 class="auth__header">Create your account</h3>
      <p class="auth__header-text">Fill in all fields to register</p>
      ...
      <div class="auth__block">
        <p class="auth__form-text">Username</p>
        <form class="auth__form">
          <input
            v-model="data.name"
            class="auth__input"
      ...
      <div class="auth__block">
        <div class="auth__block-container">
          <p class="auth__form-text">Password repeat</p>
        </div>
        <form class="auth__form">
          <input
      ...
      <div class="auth__block">
        <a class="auth__link" @click="register">Join</a>
